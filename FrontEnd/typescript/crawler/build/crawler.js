...
var Crawler = /** @class */ (function () {
    function Crawler(analyer, url, secret) {
        this.analyer = analyer;
        this.url = url;
        this.secret = secret;
        this.filePath = path_1.default.resolve(__dirname, '../course.json');
    ...
    Crawler.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            var rawHTML, fileContent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRawHTML()];
                    case 1:
                        rawHTML = _a.sent();
                        fileContent = this.analyer.analyze(rawHTML, this.filePath);
...
var crawler = new Crawler(analyzer, url, secret);
var a = 3;
